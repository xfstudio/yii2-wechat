...
use xfstudio\wechat\mp\Card;
use xfstudio\wechat\mp\Shop;
use xfstudio\wechat\mp\ShakeAround;
use xfstudio\wechat\mp\DataCube;
use xfstudio\wechat\mp\CustomService;
